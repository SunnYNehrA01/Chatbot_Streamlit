...
def main():
    ...
    if choice == "Home":
        ...
        if user_input:
            ...
            # Display user input and chatbot response in the conversation box
            st.session_state.messages.append({"role": "user", "message": user_input_str})
            ...
            for message in st.session_state.messages:
                if message['role'] == 'user':
                    ...
                    st.markdown(f"*Chatbot:* {message['message']}")
